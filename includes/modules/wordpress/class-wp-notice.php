...
class WP_Notice {
	...
	/**
	 * @var \VSP\Core\Interfaces\WP_Admin_Notice
	 */
	protected $formatter;
	/**
	 * @var bool
	...
	/**
	 * @return \VSP\Modules\WordPress\Admin\Notice|\VSP\Modules\WordPress\Admin\Sticky_Notice
	 * @author Panagiotis Vagenas <pan.vagenas@gmail.com>
	 * @since  TODO ${VERSION}
	 */
	protected function getDefaultFormatter() {
		if ( $this->isSticky() ) {
			return new Admin\Sticky_Notice();
		}

		return new Admin\Notice();
	}
	 ...
	 *
	 * @return string|array Current screens slug
	 */
	...
	/**
	 * @return \VSP\Core\Interfaces\WP_Admin_Notice
	 * @author Panagiotis Vagenas <pan.vagenas@gmail.com>
	 * @since  2.0.0
	 */
	...
	/**
	 * @param \VSP\Core\Interfaces\WP_Admin_Notice $formatter
	 *
	 * @return $this
	...
	public function setFormatter( $formatter ) {
		if ( ! ( $formatter instanceof \VSP\Core\Interfaces\WP_Admin_Notice ) ) {
