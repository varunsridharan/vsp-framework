...
class Notices {
	 ...
	 *
	 * @since 1.0.0
	 * @var \VSP\Modules\WordPress\Admin\Notices
	 */
	 ...
	 *
	 * @since 1.0.0
	 * @return \VSP\Modules\WordPress\Admin\Notices
	 */
	...
	public function displayNotices() {
		foreach ( $this->notices as $index => $notice ) {
			/* @var \VSP\Modules\WordPress\WP_Notice $notice */
	 ...
	 * @return bool
	 */
	private function isTimeToDisplayNtc( \VSP\Modules\WordPress\WP_Notice $notice ) {
	 ...
	 * @since  2.0.0
	 */
	private function isTimeToDisplayNtcForScreen( \VSP\Modules\WordPress\WP_Notice $notice ) {
	 ...
	 * @since  2.0.0
	 */
	private function isTimeToDisplayNtcForUser( \VSP\Modules\WordPress\WP_Notice $notice ) {
	 ...
	 * @since  2.0.0
	 */
	private function ntcExceededMaxTimesToDisplay( \VSP\Modules\WordPress\WP_Notice $notice ) {
		if ( $notice->isSticky() ) {
			return false;
		}
	 ...
	 * @since  TODO ${VERSION}
	 */
	private function isTimeToKillNtc( \VSP\Modules\WordPress\WP_Notice $notice ) {
		if ( $notice->isSticky() ) {
			return false;
		}
	 ...
	 * @param $noticeId
	 *
	 * @return null|\VSP\Modules\WordPress\WP_Notice
	 * @author Panagiotis Vagenas <pan.vagenas@gmail.com>
	 * @since  TODO ${VERSION}
	 */
	 ...
	 * @param \VSP\Modules\WordPress\WP_Notice $notice
	 */
	public function addNotice( \VSP\Modules\WordPress\WP_Notice &$notice ) {
		$this->notices[] = $notice;
		$this->storeNotices();
	}
}
