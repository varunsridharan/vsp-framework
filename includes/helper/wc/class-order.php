	...
	class Order extends Data_Compatibility {
		...
		public static function get_date_prop( WC_Order $order, $type, $context = 'edit' ) {
			...
			if ( WC::is_wc_version_gte_3_0() ) {
				...
				if ( $date ) {
					try {
						$date = new Date_Time( $date, new DateTimeZone( wc_timezone_string() ) );
		...
		public static function get_item_formatted_meta_data( $item, $hideprefix = '_', $include_all = false ) {
			if ( WC::is_wc_version_gte_3_1() && $item instanceof \WC_Order_Item ) {
