...
if(!class_exists("VSP_WP_Settings_Handler")){
    class VSP_WP_Settings_Handler extends VSP_Class_Handler {
        ...
        private function init_fields_class(){
            if(!class_exists("VSP_WP_Settings_Fields")){
                include(VSP_CLASS.'settings/class-settings-fields.php');
            }
            return $this->fields = new VSP_WP_Settings_Fields;
        }
        ...
        public function render_form(){
            ...
            if(!empty($page)){
                ...
                foreach($forms as $form){
                    ...
                    $this->output($this->filter("form_fields",'',$form['id'],$form));
        ...
        protected function localize( $object_name, $l10n ) {
