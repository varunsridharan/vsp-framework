 ...
 * @since 4.6.0
 */
class VSP_WC_Product_Compatibility extends VSP_WC_DATA_Compatibility {
    ...
    public static function get_prop($object, $prop, $context = 'edit', $compat_props = array()) {
        ...
        if( VSP_Framework_Helper::is_wc_version_lt_3_0() && 'parent_id' === $prop ) {
            $prop = 'id';
    ...
    public static function product_type(\WC_Product $product) {
        return ( VSP_Framework_Helper::is_wc_version_gte_3_0() ) ? $product->get_type() : $product->product_type;
    }
