...
if(!class_exists("VSP_Addons_Core")){
    class VSP_Addons_Core extends VSP_Addons_File_Meta {
        ...
        public function search_get_addons($single_addon = false){
            ...
            $dirs = apply_filters($this->hook_slug.'_addons_dirs',array('D:\http\htdocs\wp-plugins\boilerplate\wp-content\plugins\addons/'));
