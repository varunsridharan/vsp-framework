...
if(!class_exists("VSP_Addons_Admin")){
    class VSP_Addons_Admin extends VSP_Addons_Core{
        ...
        public function render_addons_page($none,$form_id){
            ...
            echo $this->render_category_html();
            echo $this->render_addons_html();
        }
        ...
        public function render_single_addon(){
            ...
            foreach($this->addons_list as $file => $data){
                ...
                $html .= '<div id="'.$addon_slug.'" class="'.$wrapperClass.'" data-pathid="'.md5($data['addon_path']).'">';
