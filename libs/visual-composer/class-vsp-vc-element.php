...
trait VSP_VC_Element {
    ...
    public function getStyles($el_class = '', $css = '', $font_data = array(), $use_theme_fonts = FALSE) {
        ...
        if( ( $use_theme_fonts === FALSE || empty($use_theme_fonts) ) && ! empty($gfonts) && isset($gfonts['values'], $gfonts['values']['font_family'], $gfonts['values']['font_style']) ) {
