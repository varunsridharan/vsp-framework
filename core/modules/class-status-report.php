    ...
    class VSP_Status_Report {
        ...
        public function headings() {
            return apply_filters('vsp_sys_status_heading', array(
                'vsp_framework'    => array( "name" => __("VSP Framework", 'vsp-framework'), 'deep_loop' => TRUE ),
                'wp_env'           => array(
                ...
                'php_info'         => array( "name" => __("PHP Environment", 'vsp-framework'), 'deep_loop' => FALSE ),
                'php_exts'         => array( "name" => __("PHP Extenstions", 'vsp-framework'), 'deep_loop' => FALSE ),
                'session_config'   => array( "name" => __("Session Config", 'vsp-framework'), 'deep_loop' => FALSE ),
                'active_theme'     => array( "name" => __("Active Theme", 'vsp-framework'), 'deep_loop' => FALSE ),
                'active_plugins'   => array( "name" => __("Active Plugins", 'vsp-framework'), 'deep_loop' => TRUE ),
                'msite_plugins'    => array(
        ...
        public function output_html() {
            ...
            foreach( $heads as $var => $_hdata ) {
                ...
                if( isset($_hdata['deep_loop']) && $_hdata['deep_loop'] === TRUE ) {
                    foreach( $datas as $i => $infos ) {
                        ...
                        if( is_array($infos) ) {
                            ...
                            if( is_array($infos) ) {
                                $infos = json_encode($infos) . PHP_EOL;
                            }
