 ...
 *  } catch(VSP_Cache_Not_Found_Exception $e) {
...
class VSP_Cache {
	...
	public static function _init() {
		self::$not_found_value = new VSP_Cache_Not_Found_Exception();
	...
	public static function set( $keys, $value, $keys_delimiter = '/' ) {
		...
		VSP_Helper::aks( $keys, $value, self::$cache, $keys_delimiter );
	...
	public static function del( $keys, $keys_delimiter = '/' ) {
		VSP_Helper::aku( $keys, self::$cache, $keys_delimiter );
	 ...
	 *
	 * @return mixed
	 * @throws VSP_Cache_Not_Found_Exception
	 */
	public static function get( $keys, $keys_delimiter = '/' ) {
		...
		$value = VSP_Helper::akg( $keys, self::$cache, self::$not_found_value, $keys_delimiter );
		...
		if ( $value === self::$not_found_value ) {
			...
			throw new VSP_Cache_Not_Found_Exception();
		} else {
			++self::$hits;
	...
	public static function stats() {
		...
		echo '<strong>PHP Memory Peak Usage:</strong> ' . VSP_Helper::to_human_bytes( memory_get_peak_usage( false ) ) . '<br />';
		echo '</p>';
		echo '<ul>';
...
class VSP_Cache_Not_Found_Exception extends Exception {
}
